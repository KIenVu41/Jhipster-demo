...
export class CategoryService {
  ...
  protected convertDateFromClient(category: ICategory): ICategory {
    return Object.assign({}, category, {
      ...
      updatedDate: category.updatedDate?.isValid() ? category.updatedDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((category: ICategory) => {
        ...
        category.updatedDate = category.updatedDate ? dayjs(category.updatedDate) : undefined;
      });
    }
    return res;
  }
